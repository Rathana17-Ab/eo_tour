...
@section('content')
        ...
        <div class="row justify-content-center align-items-center" style="min-height: 80vh;">
            <div class="col-md-5">
                <div class="card border-0 shadow-lg rounded-4">
                    <div class="bg-white text-black text-center py-4 rounded-top-4 border-0">
                    ...
                    <div class="card-body p-5 bg-login">
    ...
    <style>
           .bg-login{
            background-image: url("{{ asset('assets/img/kaiadmin/eot-logo.png') }}") !important;
